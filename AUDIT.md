...
5. **[Medium]** Expose MazeGenerator in terrain selection: Add "maze" to the terrain-type CLI options if maze dungeons are a desired feature.

6. **[Low]** Remove legacy system structs: `CompanionHousingSystem` and `HousingCraftingSystem` are superseded by manager patterns. Consider removing or documenting as deprecated.
