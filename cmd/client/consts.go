...
const (
	...
	seedOffsetSpecCritDamage     = 19000 // offset for specialization crit damage system (class-crit integration)
	seedOffsetSpecEvasion        = 19500 // offset for specialization evasion system (class-evasion integration)
	seedOffsetDualClassSynergy   = 20000 // offset for dual-class synergy system (class combination bonuses)
