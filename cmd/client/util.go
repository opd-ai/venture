...
var (
	...
	postprocessChromaticAber   = flag.Bool("postprocess-chromatic", false, "Enable chromatic aberration effect")
	postprocessSaturation      = flag.Float64("postprocess-saturation", 1.0, "Color grading saturation (0.0-2.0)")
	postprocessContrast        = flag.Float64("postprocess-contrast", 1.0, "Color grading contrast (0.0-2.0)")
	postprocessBrightness      = flag.Float64("postprocess-brightness", 0.0, "Color grading brightness (-1.0 to 1.0)")
