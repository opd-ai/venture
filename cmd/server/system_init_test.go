...
func TestInitializeV4Systems_Deterministic(t *testing.T) {
	...
	initializeV4Systems(world1, seed, logger)
	initializeV4Systems(world2, seed, logger)
...
func TestInitializeV8SystemsServer(t *testing.T) {
	...
	t.Logf("V8 systems initialized: %d systems added", addedSystems)
}
...
func TestInitializeV4Systems_DifferentSeeds(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			initializeV4Systems(world, tt.seed, logger)
