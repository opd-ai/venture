...
- [ ] **Error handling edge case** — `generateMessageID()` falls back to timestamp-based ID on crypto rand failure but logs nothing. Should use structured logging to report fallback. (`chat.go:18`)
