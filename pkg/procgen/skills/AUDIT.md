...
### Medium Severity
- [x] **Documentation** — template function godoc — **ALREADY RESOLVED**: all five functions have godoc at their declaration sites (templates.go:38, 270, 580, 887, 1193).
...
### Low Severity
- [x] **Code Style** — normalizeGenre extraction — **DEFERRED**: package-private helpers are idiomatic Go; cross-package reuse would require a separate utils package which adds indirection.
