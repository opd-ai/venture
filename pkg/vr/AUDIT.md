...
- [x] **Missing benchmarks** — No benchmarks for `IsHeadsetDetected()` or `IsControllerDetected()` read-path (these use RWMutex and could benefit from benchmark profiling)
